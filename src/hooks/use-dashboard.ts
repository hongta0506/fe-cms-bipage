...
export function useContent(schema: string, options?: { page?: number; pageSize?: number; sort?: string; search?: string; searchField?: string }) {
...
export function useContentAll(schema: string, options?: { page?: number; pageSize?: number; sort?: string; search?: string; searchField?: string }) {
  return useQuery({
